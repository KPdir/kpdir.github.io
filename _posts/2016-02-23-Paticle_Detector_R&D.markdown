...
This project was carried out at Queen's University along with members of the SuperCDMS research group at Queen's and formed a major portion of my thesis project for MSc in Physics. Linked here is the [full text of the thesis](http://cdms.berkeley.edu/Dissertations/page.pdf). This project was part of a larger detector R&D effort at the SuperCDMS collaboration targeted towards a bigger version of the experiment in future.
